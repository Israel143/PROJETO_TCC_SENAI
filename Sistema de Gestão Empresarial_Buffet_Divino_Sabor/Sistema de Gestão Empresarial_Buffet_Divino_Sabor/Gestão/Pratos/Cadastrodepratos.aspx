...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>Menu:</p>
    <asp:DropDownList runat="server" ID="ddlescolhas" OnSelectedIndexChanged="ddlescolhas_SelectedIndexChanged" AutoPostBack="true">
    ...
    <div class="col-sm-12">
        ...
        <asp:TextBox runat="server" ID="txtcadastrar" class="txtbox"></asp:TextBox>
        <asp:Button runat="server" ID="btnCadastrarPrato" OnClick="btnCadastrarPrato_Click" />
